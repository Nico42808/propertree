...
import { Menu, X, Heart, Calendar, LayoutDashboard, LogOut, User, Wrench, TrendingUp, Activity, Building } from 'lucide-react';
                ...
                <div className={`relative flex-shrink-0 ${isAdminUser ? 'ml-1' : 'ml-2'}`}>
                  ...
                  >
                    <Avatar
                      ...
                      name={user?.profile?.first_name || user?.first_name || user?.email}
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="mt-2 pt-2 border-t border-gray-100 px-1">
                  <LanguageSwitcher align="left" direction="up" fullWidth showLabelOnMobile />
                </div>
              </>
            ) : (
              <>
