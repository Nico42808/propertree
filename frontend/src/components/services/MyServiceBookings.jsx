/**
 * My Services component - Display the owner's service requests,
  ...
  if (bookingsList.length === 0) {
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-12 text-center">
        <p className="text-gray-600 text-lg mb-2">No Service Requests Yet</p>
        <p className="text-gray-500 text-sm">
          Request a Service From the Catalog to Get Started
        </p>
      </div>
    );
  }
