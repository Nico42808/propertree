    ...
    <div className="bg-white text-propertree-dark">
      <section className="relative overflow-hidden bg-propertree-cream-100 px-6 py-16 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          <a href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-propertree-dark transition hover:text-propertree-green">
          ...
          <div className="mt-10 grid items-end gap-10 lg:grid-cols-[1fr_auto]">
            <div className="max-w-3xl">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-propertree-green">{eyebrow}</p>
              <h1 className="mt-4 text-4xl font-semibold tracking-tight text-propertree-dark sm:text-5xl lg:text-6xl">{title}</h1>
              {intro && <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-600 sm:text-xl">{intro}</p>}
            </div>
      ...
      <section className="px-6 pb-20 lg:px-8 lg:pb-24">
        <div className="mx-auto max-w-6xl">
          <div className="rounded-3xl bg-propertree-green px-8 py-12 text-center text-white md:px-12 md:py-14">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-white/70">Propertree</p>
            <h2 className="mx-auto mt-4 max-w-2xl text-3xl font-semibold tracking-tight md:text-4xl">Your property. Professionally managed.</h2>
            <a href={ctaTo} className="mt-7 inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3.5 font-semibold text-propertree-dark transition hover:bg-gray-100">
              {ctaLabel}
