"""
Django settings for Propertree project.
"""
...
# CORS settings
# Used to build links (e.g. password reset) that point back to the frontend
FRONTEND_URL = config('FRONTEND_URL', default='https://propertree.site')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@propertree.com')
